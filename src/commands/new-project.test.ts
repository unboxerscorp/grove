...
describe("createNewProject", () => {
  test("creates a detached session, default workspace, board, and project lead", async () => {
    ...
    expect(savedRegistry.nodes["lead"]?.role).toContain("grove org --all --json");
